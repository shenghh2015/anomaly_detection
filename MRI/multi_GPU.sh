...
# June 01
# Run 1
# JOB: python AE_labels.py --gpu 0 --cn 4 --fr 32 --ks 5 --bn True --lr 5e-6 --step 100000 --bz 50 --version 1 --train 65000 --val 400 --test 1000 --loss 'mae' --ano_weight 0.05 --anomaly x3
# JOB: python AE_labels.py --gpu 1 --cn 4 --fr 32 --ks 5 --bn True --lr 5e-6 --step 100000 --bz 50 --version 1 --train 65000 --val 400 --test 1000 --loss 'mae' --ano_weight 0.05 --anomaly x3
# RUN 2
JOB: python AE_labels.py --gpu 0 --cn 4 --fr 32 --ks 5 --bn True --lr 5e-6 --step 100000 --bz 50 --version 1 --train 65000 --val 400 --test 1000 --loss 'mae' --ano_weight 0.05 --anomaly x2
JOB: python AE_labels.py --gpu 1 --cn 4 --fr 32 --ks 5 --bn True --lr 5e-6 --step 100000 --bz 50 --version 1 --train 65000 --val 400 --test 1000 --loss 'mae' --ano_weight 0.05 --anomaly x2