...
JOB: python AE_labels.py --gpu 0 --cn 6 --fr 32 --ks 5 --bn True --lr 1e-4 --step 200000 --bz 50 --version 1 --train 65000 --val 400 --test 1000 --loss 'mae'
JOB: python AE_labels.py --gpu 1 --cn 4 --fr 32 --ks 5 --bn True --lr 1e-4 --step 200000 --bz 50 --version 4 --train 65000 --val 400 --test 1000 --loss 'mae'