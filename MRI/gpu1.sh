...
# python AE_labels.py --gpu 0 --cn 6 --fr 32 --ks 5 --bn True --lr 1e-4 --step 100000 --bz 50 --version 1 --train 65000 --val 400 --test 1000 --loss mae --ano_weight 0.05
python AE_labels.py --gpu 1 --cn 6 --fr 32 --ks 5 --bn True --lr 5e-6 --step 100000 --bz 50 --version 1 --train 65000 --val 400 --test 1000 --loss mae --ano_weight 0.01 --anomaly 3x