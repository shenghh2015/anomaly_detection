...
python AE.py --gpu 0 --cn 4 --fr 32 --ks 3 --bn True --lr 1e-4 --step 200000 --bz 50 --train 65000 --val 200 --test 200 --noise 30 --version 2
# python AE_ssim.py --gpu 0 --cn 6 --fr 32 --ks 3 --bn True --lr 1e-3 --step 300000 --bz 50 --train 33000 --val 200 --test 200 --version 2 --dataset scattered --loss ssim